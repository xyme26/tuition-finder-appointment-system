...
<head>
    ...
    <style>
        ...
        /* Position for first input's icon (search) */
        .input-group .fa-search {
            left: 12px;
        }

        /* Position for second input's icon (location) */
        .input-group .fa-location-dot {
            left: calc(50% + 12px); /* Positions icon in the second input */
        }
        ...
        .search-section button {
            min-width: 120px;
            margin: 0 !important; /* Remove any margin that might be causing stacking */
