...
// 8.2 Test notification creation
try {
...
// 8.3 Test notification retrieval
...
// 8.4 Test notification preferences
try {
...
// 8.5 Test notification marking as read
if (isset($new_notification_id)) {
    try {
...
// 8.6 Clean up test notification
if (isset($new_notification_id)) {
    try {
